# Introduction
These sample .nml files are for training a Least Square gan model using image data in [NeoPulse™ AI Studio](https://aws.amazon.com/marketplace/pp/B074NDG36S/ref=vdr_rf).
...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/GANs/lsgan/MNIST/mnist_lsgan.nml
```
...
**mnist_lsgan.nml:** Full self-defined architecture without any automation.

**mnist_lsgan_auto.nml:** Features full use of the auto keyword to automatically generate the entire architecture and hyperparameters values.
