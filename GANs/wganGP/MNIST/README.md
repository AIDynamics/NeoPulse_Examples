# Introduction
These sample .nml files are for training a wasserstein gan with gradient penalty model using image data in [NeoPulse™ AI Studio](https://aws.amazon.com/marketplace/pp/B074NDG36S/ref=vdr_rf).
...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/GANs/wganGP/MNIST/mnist_wganGP.nml
```
...
**mnist_wganGP.nml:** Full self-defined architecture without any automation.

**mnist_wganGP_auto.nml:** Features full use of the auto keyword to automatically generate the entire architecture.
