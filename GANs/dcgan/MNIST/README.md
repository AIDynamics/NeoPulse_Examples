# Introduction
These sample .nml files are for training a Deep Convolutional gan model using image data in [NeoPulse™ AI Studio](https://aws.amazon.com/marketplace/pp/B074NDG36S/ref=vdr_rf).
...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/GANs/dcgan/MNIST/mnist_dcgan.nml
```
...
**mnist_dcgan.nml:** Full self-defined architecture without any automation.

**mnist_dcgan_auto.nml:** Features full use of the auto keyword to automatically generate the entire architecture.
