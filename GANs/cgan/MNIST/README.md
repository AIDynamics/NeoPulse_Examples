# Introduction
These sample .nml files are for training a Conditional gan model using image data in [NeoPulse™ AI Studio](https://aws.amazon.com/marketplace/pp/B074NDG36S/ref=vdr_rf).
...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/GANs/cgan/MNIST/mnist_cgan.nml
```
...
# Tutorial Files
**build_csv.py:** Script creates list of training files and writes training full image paths, a vector of noise and corresponding labels to a training CSV file.

**mnist_cgan.nml:** Full self-defined architecture without any automation.
