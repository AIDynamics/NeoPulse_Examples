...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/CapsuleNetworks/vector_capsule/Image/MNIST/mnist_capsule.nml
```
...
```bash
bind = "/DM-Dash/NeoPulse_Examples/CapsuleNetworks/vector_capsule/Image/MNIST/training_data.csv" ;
```
...
**mnist_vector_capsule.nml:** Full self-defined architecture without any automation.

**mnist_vector_capsule_auto.nml:** Features full use of the auto keyword to automatically generate the entire architecture and hyperparameters values.
