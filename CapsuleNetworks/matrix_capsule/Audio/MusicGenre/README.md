...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/CapsuleNetworks/matrix_capsule/Audio/music_capsule.nml
```
...
```bash
bind = "/DM-Dash/NeoPulse_Examples/CapsuleNetworks/matrix_capsule/Audio/training_data.csv" ;
```
