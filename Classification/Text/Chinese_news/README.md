...
```bash
$ neopulse train -p <project_name> -f /DM-Dash/NeoPulse_Examples/Classification/Text/Chinese_news/cnews.nml
```
...
```bash
bind = "/DM-Dash/NeoPulse_Examples/Classification/Text/Chinese_news/training_data.csv" ;
```
